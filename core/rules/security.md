...
Agents, adapters, external integrations, execution permissions, provider routes, generated configuration, credentials, and automated commands must be treated as security-relevant configuration.

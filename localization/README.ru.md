...
> **Примечание о релизе:** текущий публичный релиз в PyPI — `v0.1.0`. Автоматический выбор версии EmbrAIon для каждого проекта уже реализован в `main` и войдёт в следующий релиз.
...
Текущий `main` нацелен на `v0.2.0` и добавляет автоматический выбор версии EmbrAIon для каждого проекта.

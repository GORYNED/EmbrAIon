...
यदि प्रोजेक्ट कोई override नहीं देता, तो चुना हुआ AI host अपनी default/automatic model selection का उपयोग करता है। स्पष्ट चयन की आवश्यकता होने पर प्रोजेक्ट host-specific `model`, `effort` और `options` को `.embraion/routing.yaml` → `overrides` में रख सकता है।

...
3. **Tools (Инструменты)** — детерминированная исполняемая логика: среда выполнения, обучение, безопасность, инвентаризация MCP, управление рабочими деревьями Git, валидация, синхронизация, установка, диагностика и интерфейс командной строки.

...
`embraion validate` सक्रिय EmbrAIon स्थापना के साथ आए सिस्टम डेटा की जाँच करता है। `embraion doctor` सामान्य रूप से मानव-पठनीय निदान रिपोर्ट दिखाता है और अपने आप पहचानता है कि वर्तमान फ़ोल्डर किसी Git रिपॉजिटरी या EmbrAIon प्रोजेक्ट के भीतर है या नहीं। प्रोजेक्ट के बाहर यह केवल स्थापना और सिस्टम निदान चलाता है; उपयोगकर्ता की home directory या किसी सामान्य फ़ोल्डर को recursively scan नहीं करता। मशीन-पठनीय संरचित आउटपुट के लिए `embraion doctor --json` उपयोग करें।
...
`v0.2.0` हर प्रोजेक्ट के लिए EmbrAIon संस्करण का स्वचालित चयन जोड़ता है।
